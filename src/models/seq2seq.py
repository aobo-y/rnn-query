...
class Seq2Seq(nn.Module):
    ...
    def __init__(self, word_ebd_shape, hidden_size, layer_size=1, dropout_rate=0, rnn_type='LSTM', attn_type='dot'):
        '''
        ...
        self.decoder = DecoderRNN(self.word_ebd, hidden_size, word_ebd_shape[0], layer_size, dropout_rate, rnn_type, attn_type)
    ...
    def forward(self, input_var, lengths, target_var, max_length, tf_rate=0):
        ...
        if teacher_forcing:
            ...
            output_var, decoder_hidden = self.decoder(target_var, decoder_hidden, encoder_outputs)
        else:
            ...
            for _ in range(max_length):
                output_step, decoder_hidden = self.decoder(decoder_var, decoder_hidden, encoder_outputs)
